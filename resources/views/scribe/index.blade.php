    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-logout">Logout user (revoke token)</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    ...
                    <ul id="tocify-header-followers" class="tocify-header">
                <li class="tocify-item level-1" data-unique="followers">
                    ...
                    <ul id="tocify-header-friends" class="tocify-header">
                <li class="tocify-item level-1" data-unique="friends">
                    <a href="#friends">Friends</a>
                                ...
                                <a href="#friends-POSTapi-friends-accept">Accept a friend request.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="friends-POSTapi-friends-unfriend">
                                <a href="#friends-POSTapi-friends-unfriend">Unfriend a user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="friends-POSTapi-friends-block">
                                <a href="#friends-POSTapi-friends-block">Block a user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="friends-POSTapi-friends-restrict">
                                <a href="#friends-POSTapi-friends-restrict">Restrict a user.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="likes">
                    <a href="#likes">Likes</a>
                                    ...
                                    <ul id="tocify-subheader-likes" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="likes-POSTapi-posts--post_id--like">
                                <a href="#likes-POSTapi-posts--post_id--like">Toggle like for a post.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="messaging">
                    <a href="#messaging">Messaging</a>
                                    ...
                                    <ul id="tocify-subheader-messaging" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="messaging-GETapi-messages">
                                <a href="#messaging-GETapi-messages">Retrieve all messages for the authenticated user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messaging-POSTapi-messages">
                                <a href="#messaging-POSTapi-messages">Send a new message to another user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messaging-PUTapi-messages--message_id-">
                                <a href="#messaging-PUTapi-messages--message_id-">Update a message.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messaging-DELETEapi-messages--message_id-">
                                <a href="#messaging-DELETEapi-messages--message_id-">Delete a message.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="notifications">
                    <a href="#notifications">Notifications</a>
                                ...
                                <a href="#notifications-GETapi-notifications">Retrieve all notifications for the authenticated user.</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="posts">
                    <a href="#posts">Posts</a>
                                ...
                                <a href="#posts-GETapi-posts">Display all posts.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="posts-POSTapi-posts">
                                <a href="#posts-POSTapi-posts">Store a new post.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="posts-GETapi-posts--id-">
                                <a href="#posts-GETapi-posts--id-">Show a specific post.</a>
                            </li>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <p>APIs for user registration and login</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email. Example: <code>"jane@example.com"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>The user's password. Example: <code>"secret123"</code></p>
                    ...
                    <h2 id="authentication-POSTapi-logout">Logout user (revoke token)</h2>
...
<p>Returns all friend requests where the authenticated user is the recipient
and the status is &quot;pending&quot;.</p>

<span id="example-requests-GETapi-friends-requests">
<blockquote>Example request:</blockquote>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/friends/requests"
);
...
<span id="example-responses-GETapi-friends-requests">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-friends-requests" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-friends-requests"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-friends-requests"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-friends-requests" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-friends-requests">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-friends-requests" data-method="GET"
      data-path="api/friends/requests"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-friends-requests', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-friends-requests"
                    onclick="tryItOut('GETapi-friends-requests');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-friends-requests"
                    onclick="cancelTryOut('GETapi-friends-requests');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-friends-requests"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/friends/requests</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-friends-requests"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-friends-requests"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-friends-requests"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>friend_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               ...
               data-component="body">
    <br>
<p>The ID of the user to send a request to. Example: <code>2</code></p>
        </div>
        </form>

                    <h2 id="friends-POSTapi-friends-accept">Accept a friend request.</h2>
...
<span id="example-requests-POSTapi-friends-accept">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/friends/accept" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-friends-accept">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-friends-accept" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-friends-accept"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-friends-accept"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-friends-accept" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-friends-accept">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-friends-accept" data-method="POST"
      data-path="api/friends/accept"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-friends-accept', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-friends-accept"
                    onclick="tryItOut('POSTapi-friends-accept');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-friends-accept"
                    onclick="cancelTryOut('POSTapi-friends-accept');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-friends-accept"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-friends-accept"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-friends-accept"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-friends-accept"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="request_id"                data-endpoint="POSTapi-friends-accept"
               value="5"
               data-component="body">
    <br>
<p>The ID of the friend request. Example: <code>5</code></p>
        </div>
        </form>

                    <h2 id="friends-POSTapi-friends-unfriend">Unfriend a user.</h2>
...
<span id="example-requests-POSTapi-friends-unfriend">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/friends/unfriend" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-friends-unfriend">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-friends-unfriend" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-friends-unfriend"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-friends-unfriend"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-friends-unfriend" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-friends-unfriend">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-friends-unfriend" data-method="POST"
      data-path="api/friends/unfriend"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-friends-unfriend', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-friends-unfriend"
                    onclick="tryItOut('POSTapi-friends-unfriend');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-friends-unfriend"
                    onclick="cancelTryOut('POSTapi-friends-unfriend');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-friends-unfriend"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-friends-unfriend"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-friends-unfriend"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-friends-unfriend"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="friend_id"                data-endpoint="POSTapi-friends-unfriend"
               value="3"
               data-component="body">
    <br>
<p>The ID of the user to unfriend. Example: <code>3</code></p>
        </div>
        </form>

                    <h2 id="friends-POSTapi-friends-block">Block a user.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/friends/block" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-friends-block"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="friend_id"                data-endpoint="POSTapi-friends-block"
               value="4"
               data-component="body">
    <br>
<p>The ID of the user to block. Example: <code>4</code></p>
        </div>
        </form>

                    <h2 id="friends-POSTapi-friends-restrict">Restrict a user.</h2>
...
<span id="example-requests-POSTapi-friends-restrict">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/friends/restrict" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-friends-restrict">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-friends-restrict" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-friends-restrict"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-friends-restrict"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-friends-restrict" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-friends-restrict">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-friends-restrict" data-method="POST"
      data-path="api/friends/restrict"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-friends-restrict', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-friends-restrict"
                    onclick="tryItOut('POSTapi-friends-restrict');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-friends-restrict"
                    onclick="cancelTryOut('POSTapi-friends-restrict');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-friends-restrict"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/friends/restrict</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-friends-restrict"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-friends-restrict"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-friends-restrict"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="friend_id"                data-endpoint="POSTapi-friends-restrict"
               value="5"
               data-component="body">
    <br>
<p>The ID of the user to restrict. Example: <code>5</code></p>
        </div>
        </form>

                <h1 id="likes">Likes</h1>

    <p>APIs for liking and unliking posts</p>

                                <h2 id="likes-POSTapi-posts--post_id--like">Toggle like for a post.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>If the user has already liked the post, it will be unliked. Otherwise, it will be liked.</p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-posts--post_id--like"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="post"                data-endpoint="POSTapi-posts--post_id--like"
               value="1"
               data-component="url">
    <br>
<p>The ID of the post to like or unlike. Example: <code>1</code></p>
            </div>
                    </form>

                <h1 id="messaging">Messaging</h1>

    <p>APIs for sending, retrieving, updating, and deleting messages</p>

                                <h2 id="messaging-GETapi-messages">Retrieve all messages for the authenticated user.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieves messages where the authenticated user is either the sender or receiver,
including sender and receiver details.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="messaging-POSTapi-messages">Send a new message to another user.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Allows the authenticated user to send a message to a specific user.</p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The ID of the user receiving the message. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The content of the message. Example: <code>"Hello, how are you?"</code></p>
        </div>
        </form>

                    <h2 id="messaging-PUTapi-messages--message_id-">Update a message.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Allows the sender of a message to update its content.</p>

<span id="example-requests-PUTapi-messages--message_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://127.0.0.1:8000/api/messages/1" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-PUTapi-messages--message_id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-messages--message_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-messages--message_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-messages--message_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-messages--message_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-messages--message_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-messages--message_id-" data-method="PUT"
      data-path="api/messages/{message_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-messages--message_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-messages--message_id-"
                    onclick="tryItOut('PUTapi-messages--message_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-messages--message_id-"
                    onclick="cancelTryOut('PUTapi-messages--message_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-messages--message_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/messages/{message_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-messages--message_id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-messages--message_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-messages--message_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="message_id"                data-endpoint="PUTapi-messages--message_id-"
               value="1"
               data-component="url">
    <br>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="message"                data-endpoint="PUTapi-messages--message_id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the message to update. Example: <code>17</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>content</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="PUTapi-messages--message_id-"
               value=""Updated message""
               data-component="body">
    <br>
<p>The updated message content. Example: <code>"Updated message"</code></p>
        </div>
        </form>

                    <h2 id="messaging-DELETEapi-messages--message_id-">Delete a message.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Allows the sender of a message to delete it.</p>

<span id="example-requests-DELETEapi-messages--message_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-messages--message_id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-DELETEapi-messages--message_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-messages--message_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-messages--message_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-messages--message_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-messages--message_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-messages--message_id-" data-method="DELETE"
      data-path="api/messages/{message_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-messages--message_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-messages--message_id-"
                    onclick="tryItOut('DELETEapi-messages--message_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-messages--message_id-"
                    onclick="cancelTryOut('DELETEapi-messages--message_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-messages--message_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-messages--message_id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-messages--message_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-messages--message_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="message_id"                data-endpoint="DELETEapi-messages--message_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the message. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="message"                data-endpoint="DELETEapi-messages--message_id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the message to delete. Example: <code>17</code></p>
            </div>
                    </form>

                <h1 id="notifications">Notifications</h1>

    <p>APIs for viewing, marking, and deleting notifications</p>

                                <h2 id="notifications-GETapi-notifications">Retrieve all notifications for the authenticated user.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the list of notifications for the authenticated user, ordered from newest to oldest.</p>
...
<p>Marks the notification with the specified ID as read for the authenticated user.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/notifications/17/read" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-notifications--id--read"
               value="17"
               data-component="url">
    <br>
...
<p>Deletes the notification with the specified ID for the authenticated user.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://127.0.0.1:8000/api/notifications/17" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the notification. Example: <code>17</code></p>
    ...
    <p>APIs for managing user posts</p>

                                <h2 id="posts-GETapi-posts">Display all posts.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="posts-POSTapi-posts">Store a new post.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;privacy&quot;: [
            &quot;The selected privacy is invalid.&quot;
        ]
    }
}</code>
 </pre>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The post text. Example: <code>"New post"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The post image URL. Example: <code>"https://example.com/image.jpg"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="video_url"                data-endpoint="POSTapi-posts"
               value=""https://example.com/video.mp4""
               data-component="body">
    <br>
<p>The post video URL. Example: <code>"https://example.com/video.mp4"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="privacy"                data-endpoint="POSTapi-posts"
               value=""public""
               data-component="body">
    <br>
<p>The privacy level (public/friends/private). Example: <code>"public"</code></p>
        </div>
        </form>

                    <h2 id="posts-GETapi-posts--id-">Show a specific post.</h2>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The post text. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>image_url</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The post image URL. Example: <code>http://kunze.biz/iste-laborum-eius-est-dolor.html</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>video_url</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="video_url"                data-endpoint="PUTapi-posts--id-"
               value="http://kunze.biz/iste-laborum-eius-est-dolor.html"
               data-component="body">
    <br>
<p>The post video URL. Example: <code>http://kunze.biz/iste-laborum-eius-est-dolor.html</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>privacy</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="privacy"                data-endpoint="PUTapi-posts--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>The privacy level (public/friends/private). Example: <code>consequatur</code></p>
        </div>
        </form>
